const windowsShortcutsData = [
  ...
  {
    hotkeys: ["Control", "P"],
    description: "Tìm kiếm và mở một file trong thư mục làm việc của bạn.",
    category: "VSCode",
  },
  {
    hotkeys: ["Control", "Shift", "Tab"],
    description: "Điều hướng giữa các tệp mà bạn hiện đang mở (hoặc làm việc)",
    category: "VSCode",
  },
  {
    hotkeys: ["Control", "L"],
    description: "Chọn dòng hiện tại",
    category: "VSCode",
  },
  {
    hotkeys: ["Control", "Shift", "L"],
    description: "Chọn tất cả các lần xuất hiện của lựa chọn hiện tại",
    category: "VSCode",
  },
  {
    hotkeys: ["Control", "Shift", "K"],
    description: "Xóa một dòng nơi mà con trỏ đang đứng",
    category: "VSCode",
  },
  {
  ...
  {
    hotkeys: ["Alt", "ArrowUp"],
    description: "Di chuyển dòng hiện tại lên trên",
    category: "VSCode",
  },
  {
    hotkeys: ["Alt", "ArrowDown"],
    description: "Di chuyển dòng hiện tại xuống dưới",
    category: "VSCode",
  },
  {
    hotkeys: ["Control", "`"],
  ...
  {
    hotkeys: ["Control", "G"],
    description: "Điều hướng đến dòng mong muốn trong tập tin.",
    category: "VSCode",
  },
  {
    hotkeys: ["Control", "/"],
    description: "Comment cho một dòng hoặc một block",
    category: "VSCode",
  },
  {
    hotkeys: ["Control", "\\"],
